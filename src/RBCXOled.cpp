...
void Oled::fill(OledColor color) {
    sendOledReq(CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_fill_tag,
        .oledCmd = {
...
void Oled::drawPixel(uint8_t x, uint8_t y, OledColor color) {
    sendOledReq(
        CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_drawPixel_tag,
            .oledCmd = { .drawPixel = {
                             .x = x,
                             .y = y,
...
void Oled::setCursor(uint8_t x, uint8_t y) {
    sendOledReq(
        CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_setCursor_tag,
            .oledCmd = { .setCursor = {
                             .x = x,
                             .y = y,
                         } } });
...
void Oled::drawLine(
    ...
    sendOledReq(
        CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_drawLine_tag,
            .oledCmd = { .drawLine = {
                             .x1 = x1,
                             .y1 = y1,
                             .x2 = x2,
...
void Oled::drawArc(uint8_t x, uint8_t y, uint8_t radius, uint16_t start_angle,
    uint16_t sweep, OledColor color) {
    sendOledReq(
        CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_drawArc_tag,
            .oledCmd = { .drawArc = {
                             .x = x,
                             .y = y,
                             .radius = radius,
...
void Oled::drawCircle(uint8_t x, uint8_t y, uint8_t radius, OledColor color) {
    sendOledReq(
        CoprocReq_OledReq { .which_oledCmd = CoprocReq_OledReq_drawCircle_tag,
            .oledCmd = { .drawCircle = {
                             .x = x,
                             .y = y,
                             .radius = radius,
...
void Oled::sendOledReq(CoprocReq_OledReq oledReq) {
    rb::Manager::get().sendToCoproc(CoprocReq {
        ...
        .payload = { .i2cReq = { .which_payload = CoprocReq_I2cReq_oledReq_tag,
                         .payload = {
                             .oledReq = oledReq,
                         } } } });
}
